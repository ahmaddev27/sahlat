...
(function (window, document, $) {
  ...
  // Get the data layout, for blank set to light layout
    var dataLayout = $html.attr('data-layout') ? $html.attr('data-layout') : 'dark-layout';
  ...
  // Navbar Dark / Light Layout Toggle Switch
    $('.nav-link-style').on('click', function () {
        ...
        // If currentLayout is not dark layout, switch to dark
        ...
        // Set Previous skin in local storage
        localStorage.setItem(dataLayout + '-prev-skin', currentLayout);
        // Set Current skin in local storage
    ...
    // Get current layout from local storage or default to dark
    var currentLocalStorageLayout = localStorage.getItem(dataLayout + '-current-skin') || 'dark-layout';
...
// Set layout on screen load
    ...
    function setLayout(currentLocalStorageLayout) {
        var navLinkStyle = $('.nav-link-style'),
            ...
            // Switch to local storage layout if available; otherwise, use current layout
        ...
        // Set customizer radio if present
