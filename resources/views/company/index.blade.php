@extends('company.layouts.master',['title'=>trans('dashboard_aside.dashboard')])
...
@section('left')
    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
        <div class="form-group breadcrumb-right">
            <a href="{{route('company.profile.index')}}" class="btn btn-primary waves-effect waves-float waves-light btn-sm"

                    title="{{trans('main.profile')}}"><i data-feather="user"></i></a>
        </div>
    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <a href="javascript:void(0)">
                                            <div class="item-heading">
                                                <a href="{{route('company.housekeepers.view',$h->id)}}"><h5
                                            ...
                                            <div class="item-meta">
                                                ...
                                                <ul class="product-features2 list-unstyled d-flex text-center">
                                                    <li class="d-inline-block  ">
