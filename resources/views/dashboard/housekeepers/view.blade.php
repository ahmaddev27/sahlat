@extends('dashboard.layouts.master',['title'=>$housekeeper->name])
...
@push('css')
    ...
    <style>
        ...
        .product-features2 li {
            ...
            margin: 0 0.7px; /* Add spacing between list items */
...
@section('path')
    ...
    <li class="breadcrumb-item active"><a href="{{route('housekeepers.index')}}">{{trans('dashboard_aside.housekeepers')}} </a></li>
                                ...
                                @if($housekeeper->orderd->count()>0)
                                    @foreach($housekeeper->orderd->take(5) as $order)
                                        ...
                                        <div class="d-flex justify-content-start align-items-center mt-2 ">
                                            ...
                                            <a href="{{route('housekeepers.orders.view',$order->id)}}"
                            ...
                            <div class="card-body">
                                ...
                                @foreach($housekeeper->Hourlyorderd->take(5) as $horder)
                                    <div class="d-flex justify-content-start align-items-center mt-2">
                                        ...
                                        <a href="{{route('housekeepers.HourlyOrders.view',$horder->id)}}"
                                                class="btn btn-primary btn-icon btn-sm ml-auto waves-effect waves-float waves-light">
                                            <i data-feather="eye"></i>
                                        </a>
                                    </div>
                            ...
                            <div class="swiper-responsive-breakpoints swiper-container px-4 py-2">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="{{route('companies.view',$housekeeper->company_id)}}">
