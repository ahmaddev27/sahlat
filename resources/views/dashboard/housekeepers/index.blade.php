@extends('dashboard.layouts.master',['title'=>trans('dashboard_aside.housekeepers')])
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive p-2 ">
                ...
                <div class="row">
                    ...
                    <div class="card-header p-1 col-sm-3" style="margin-bottom: -60px">
                        <div class="">{{trans('housekeeper.company')}}</div>

                        <select id="company" class="select2 form-control ">
                            <option selected disabled>{{ trans('main.change') }}</option>
                            <option value="">{{ trans('main.all') }}</option>
                ...
                <table class="table" id="table">
                    ...
                    <tr>
                        ...
                        <th style="width: 30%">{{trans('housekeeper.name')}}</th>
...
{{--                        <th>{{trans('housekeeper.type')}}</th>--}}
    ...
    @include('dashboard.housekeepers.add')
    @include('dashboard.housekeepers.edit')
